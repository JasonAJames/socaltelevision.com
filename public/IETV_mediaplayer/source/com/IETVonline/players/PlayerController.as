...
import com.IETVonline.utils.Randomizer;
import flash.geom.Rectangle;


class com.IETVonline.players.PlayerController extends AbstractController {
	...
	function PlayerController(cfg:Object,fed:Object) {
		super(cfg,fed);
		playerSO = SharedObject.getLocal("com.IETVonline.players", "/");
	};
